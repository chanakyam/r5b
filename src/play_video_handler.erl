...
welcome(Req, State) ->
	...
	Url = "http://api.contentapi.ws/videos?channel=us_mlb&limit=1&skip=5&format=long",
	...
	{ok, Body} = playvideo_dtl:render([{<<"videoParam">>,Params},{<<"newsParam">>,ParamsNews},{<<"topNewsWithImages">>,TextTopUsSportsParams}]),
    {Body, Req2, State}.
